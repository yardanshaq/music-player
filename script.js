...
let songs = [
    {
        ...
        lyrics: [
            { time: 0.8, text: "And I was never good at tellin' jokes, but the punch line goes" },
            { time: 4, text: "I'll get older, but your lovers stay my age" },
            { time: 7, text: "From when your Brooklyn broke my skin and bones" },
            { time: 10, text: "I'm a soldier who's returning half her weight" },
            { time: 13, text: "And did the twin flame bruise paint you blue?" },
            { time: 16, text: "Just between us, did the love affair maim you too?" },
            { time: 19, text: "Cause in this city's barren cold" },
            { time: 22, text: "I still remember the first fall of snow" },
            { time: 25, text: "And how it glistened as it fell" },
            { time: 28, text: "I remember it all too well" },
            { time: 31, text: "Just between us, did the love affair maim you all too well?" },
            { time: 34, text: "Just between us, do you remember it all too well?" },
            { time: 37, text: "Just between us (just between us) I remember it all too well (wind in my hair)" },
            { time: 41.5, text: "(I was there, I was there)" },
            { time: 47, text: "(Down the stairs, I was there, I was there)" },
        ]
    },
    {
        id: 2,
